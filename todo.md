...
A living backlog describing what TaleLeaf should enable for readers. Each story follows the format: *As a <role>, I want <capability> so that <benefit>*. Acceptance criteria (AC) clarify done.
