...
import { PlusIcon, SaveIcon, SparklesIcon, UndoIcon, UsersIcon } from '../ui/Icons';
            ...
            <div className="space-y-4">
                {characters.map((character, index) => (
                    <BaseEntityCard
                        ...
                        onStartNameEdit={() => {
                            setNameDrafts(prev => ({ ...prev, [character.id]: character.name }));
                            setEditingName(prev => ({ ...prev, [character.id]: true }));
                        }}
                        onNameChange={(name) => setNameDrafts(prev => ({ ...prev, [character.id]: name }))}
