    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-gray-500 bg-gray-50">
        ...
        <p className="text-sm text-gray-500 text-center max-w-sm">
          Upload a PDF or paste text content to view it here alongside your book
          analysis.
        </p>
        <div className="mt-6 px-4 py-2 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-sm text-amber-700">
            <strong>Tip:</strong> Documents appear here automatically when you
            upload them in the main interface.
          </p>
        </div>
      </div>
    );
